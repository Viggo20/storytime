...
scene.setBackgroundImage(img`
    ...
    `)
let userName = game.askForString("What is your name adventurer?")
game.showLongText("Hello there " + userName + "!", DialogLayout.Bottom)
let goodEvil = game.askForString("Are you good or evil?")
if (goodEvil == "good") {
    game.showLongText("You have chosen a glorious path wanderer!", DialogLayout.Bottom)
} else if (goodEvil == "evil") {
    game.showLongText("You have chosen the dark side!", DialogLayout.Bottom)
} else {
    game.showLongText("Wrong input", DialogLayout.Bottom)
    goodEvil = game.askForString("Are you good or evil?")
}
if (goodEvil == "good") {
    goodPath()
} else {
